// JLPT N5 Kanji Dataset (~80 kanji)
export const N5_KANJI_DATA = {
  numbers: [
  ...
  place: [
    ...
    { char: '外', meaning: 'Outside', onyomi: 'gai/ge', kunyomi: 'soto/hoka' },
    { char: '中', meaning: 'Inside / Middle', onyomi: 'chuu', kunyomi: 'naka' },
    { char: '上', meaning: 'Above / Up', onyomi: 'jou', kunyomi: 'ue/kami' },
    { char: '下', meaning: 'Below / Down', onyomi: 'ka/ge', kunyomi: 'shita/shimo' },
    { char: '右', meaning: 'Right', onyomi: 'u/yuu', kunyomi: 'migi' },
    { char: '左', meaning: 'Left', onyomi: 'sa', kunyomi: 'hidari' },
    { char: '前', meaning: 'Before / Front', onyomi: 'zen', kunyomi: 'mae' },
    { char: '後', meaning: 'After / Behind', onyomi: 'go/kou', kunyomi: 'ato/ushiro' },
  ...
  actions: [
    ...
    { char: '出', meaning: 'Exit / Come out', onyomi: 'shutsu', kunyomi: 'de/da' },
    { char: '見', meaning: 'See / Look', onyomi: 'ken', kunyomi: 'mi' },
    { char: '行', meaning: 'Go', onyomi: 'kou/gyou', kunyomi: 'i/yu' },
    { char: '来', meaning: 'Come', onyomi: 'rai', kunyomi: 'ku/ki/ko' },
    { char: '食', meaning: 'Eat', onyomi: 'shoku', kunyomi: 'ta/ku' },
  ...
  descriptors: [
    ...
    { char: '小', meaning: 'Small', onyomi: 'shou', kunyomi: 'chii/ko/o' },
    { char: '高', meaning: 'High / Expensive', onyomi: 'kou', kunyomi: 'taka' },
    { char: '安', meaning: 'Cheap / Safe', onyomi: 'an', kunyomi: 'yasu' },
    { char: '長', meaning: 'Long', onyomi: 'chou', kunyomi: 'naga' },
    { char: '白', meaning: 'White', onyomi: 'haku', kunyomi: 'shiro' },
  ...
  daily: [
    ...
    { char: '電', meaning: 'Electricity', onyomi: 'den', kunyomi: '-' },
    { char: '花', meaning: 'Flower', onyomi: 'ka', kunyomi: 'hana' },
    { char: '店', meaning: 'Shop', onyomi: 'ten', kunyomi: 'mise' },
    { char: '道', meaning: 'Road / Way', onyomi: 'dou', kunyomi: 'michi' },
    { char: '名', meaning: 'Name', onyomi: 'mei/myou', kunyomi: 'na' },
...
export const N5_EXAM_DATA = {
  ...
  mid: [
    ...
    { sentence: "にほん*ご*の べんきょうは たのしいです。", target: "語", reading: "ご", options: ["語", "話", "言", "読"], translation: "Studying Japanese is fun." }
  ],
  hard: [
